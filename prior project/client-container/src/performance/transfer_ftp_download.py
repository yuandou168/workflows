...
for count in range(run_count):
    ...
    log_event("Download file name is " + file_name)
    ...
    ftp.retrbinary("RETR " + file_name, file_object.write, file_size)
    file_object.close()
...
write_json(file_name="transfer_ftp_download_" + file_size_name, json_data=runs)
